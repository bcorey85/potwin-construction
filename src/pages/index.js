	...
	<SEO>
		<Layout>
			...
			<section className={styles.projects} id='projects'>
				...
				<p>
					Here's a small collection of our favorite recent projects.
				</p>
				<ImageGrid />
			</section>
			...
			<section className={styles.process} id='process'>
				...
				<ProcessItem
					...
					sourcing high quality materials that help us get the job
					done right.
				</ProcessItem>
				<ProcessItem
					number='3'
					...
					After your custom project is complete, we’ll review how we
					did with you. If there’s something that needs a little
					adjusting, let us know! We want you to be 100% satisfied
					with your new space.
				</ProcessItem>
			</section>
